...
<img 
  src={"../../../assets/img/preset-reset-flip-flop-circuit.png"}
...
<img 
  src={"../../../assets/img/preset-reset-flip-flop-table.png"}
...
<img 
  src={"../../../assets/img/contador-up-async.png"}
  alt="Tabela Verdade de Preset e Reset"
  style={{ 
    display: 'block',
    marginLeft: 'auto',
...
<img 
  src={"../../../assets/img/contador-up-sync-q1.png"}
  alt="Tabela Verdade de Preset e Reset"
  style={{ 
    display: 'block',
    marginLeft: 'auto',
...
<img 
  src={"../../../assets/img/contador-up-sync-q2.png"}
  alt="Tabela Verdade de Preset e Reset"
  style={{ 
    display: 'block',
    marginLeft: 'auto',
