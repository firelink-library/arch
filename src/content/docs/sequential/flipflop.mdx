...
<img 
  src={"../../../src/assets/img/retro_or.png"}
  alt="RetroOr"
  style={{ 
    display: 'block',
    marginLeft: 'auto',
...
<img 
  src={"../../../src/assets/img/retro_and.png"}
  alt="RetroAnd"
  style={{ 
    display: 'block',
    marginLeft: 'auto',
...
<img 
  src={"../../../src/assets/img/latch_rs.png"}
...
<img 
  src={"../../../src/assets/img/latch_rs_enable.png"}
