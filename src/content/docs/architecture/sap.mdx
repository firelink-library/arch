...
<img 
  src={"../../../assets/img/controlword.png"}
  alt="ControlWord"
  style={{ 
    display: 'block',
    marginLeft: 'auto',
...
<img 
  src={"../../../assets/img/ringcounter.jpg"}
  alt="RingCounter"
  style={{ 
    display: 'block',
    marginLeft: 'auto',
